...
p3 + scale_x_continuous(name="Speed of cars",
                        limits=c(0, 30)) +
...
#I turned off legends for a few to make easier to interpret.
...
####Add in something about making layered histograms!!!
